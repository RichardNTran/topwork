      ...
      <div className="card card-dashboard h-100">
        ...
        <div className="card-body pd-x-0 pd-b-10">
          {/* <div className="pd-x-20 mg-b-25 text-center">
            <button type="button" className="btn btn-sm btn-uppercase btn-white flex-fill tx-spacing-1 twbtn-primary mn-wd-170" disabled>
        ...
        {/* <div className="card-footer text-center tx-13">
          <Link to="#" className="link-03 disable">
            {i18next.t('homeContainer.teamManagement.viewAll')} <i className="topworkicon-arrow-down mg-l-5" />
          </Link>
        </div> */}
      </div>
    );
