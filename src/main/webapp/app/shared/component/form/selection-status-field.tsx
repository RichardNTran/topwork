...
class SelectionStatusField extends Component<ISelectionProps> {
  componentDidMount() {
...
const selectionStatusField = connect(
  mapStateToProps,
  mapDispatchToProps
)(SelectionStatusField);

export { selectionStatusField as SelectionStatusField };
