...
class SelectionJobsiteField extends Component<ISelectionProps> {
  componentDidMount() {
  ...
  render() {
    const { name, label, value, options, isRequired, placeholder, menuPlacement, extendOptions, showThumbnail } = this.props;
...
const selectionJobsiteField = connect(
  mapStateToProps,
  mapDispatchToProps
)(SelectionJobsiteField);

export { selectionJobsiteField as SelectionJobsiteField };
