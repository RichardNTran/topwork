...
import { topworkSidebarJQuery } from 'app/shared/jquery';
...
class SubSider extends Component<ISubSiderProps, ISubsiderState> {
  ...
  renderHeader = () => {
    ...
    switch (tabPath) {
      // todo
      // case topworkPlatformRoute.Candidates:
      //   return <HeaderCandidateSubsidebar isExtraScreen={width > lgSize} />;
      default:
        return null;
    }
  };
  ...
  renderExtendsData = () => {
    ...
    switch (tabPath) {
      // todo
      // case topworkPlatformRoute.JobOffers:
      //   return <ExtendsOccupationSubsidebar />;
      default:
        return null;
    }
  };
  ...
  render() {
    ...
    return (
      <div className="topwork-sidebar">
        {header}
        <div className={`topwork-sidebar-body ${header ? 't-65-f' : ''}`}>
